...
"""
#########################    TRY EXCEPT   #####################
Error handling function where the user try running the code and if it does not
...
the user can use the 'r' mode wc is only for reading
...
to append some more infor , the user should use the '\n' function inorder to add a new line
